...
const string strMessageMagic = "ZeroHedgeCoin0 Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZeroHedgeCoin0", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "On a long enough timeline, the survival rate for everyone drops to zero";
        CTransaction txNew;
        if (!fTestNet)
        {
            txNew.nTime = 1446144066;
        }
        else
        {
            txNew.nTime    = 1446144070; // Without separate txNew.nTime near block.nTime, CheckBlock fails on coinbase timestamp for TestNet created on 14042015
        }
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0xd06b3e34ccd5406818bf576c22ce6f6560f1405332abf5d3d9f3a0c77c69ede5"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xe0, 0xe2, 0xd3 };
